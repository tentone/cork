 ...
 */
double otsuThreshold(const Mat1b src, const Mat1b& mask)
{
	//Colors
	const int N = 256;
 ...
 */
double histogramThreshold(const Mat1b src, const Mat1b& mask, int min_color_separation = 15, int neighborhood = 15, int min_neighborhood_separation = 15, double balance = 0.5, double min_occorrences_ratio = 0.65)
{
	const int N = 256;
	int histogram[N] = {0};
